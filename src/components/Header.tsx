          ...
          >
            <a
              ...
              className={cn(
                ...
                isActive('/')
                  ? 'text-[var(--color-brand-accent)] bg-green-50'
                      ...
                      <a
                        ...
                        className={cn(
                          ...
                          currentPath.startsWith(cat.href)
                            ? 'border-[var(--color-brand-accent)] bg-green-50'
                            : 'border-slate-100 hover:border-[var(--color-brand-accent)] hover:bg-green-50'
                        )}
                      >
